...
<!-- Icons are decorative by default (every icon-only control has its own aria-label),
     so hide them from assistive tech. Opt back in with aria-label per icon if needed. -->
			...
			>
				...
				<div class="flex items-center gap-4">
					<a href="/reference/glossary" class="hover:text-brand-600 dark:hover:text-brand-400"
						>Glossary</a
					>
					<a href="/certificate" class="hover:text-brand-600 dark:hover:text-brand-400"
						>Certificate</a
					>
